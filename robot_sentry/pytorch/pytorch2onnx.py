...
if __name__ == '__main__':
    ...
    model.eval()
    input_names = ['image']#模型输入的name
    output_names = ['high_sample','low_sample']#模型输出的name
    ...
    torch.onnx.export(model,                    #model being run
                     ...
                     output_names = output_names,             # where to save the model (can be a file or file-like object)
